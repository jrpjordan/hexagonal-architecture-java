...
import com.joser.topologyinventory.domain.specification.CIDRSpecification;
import com.joser.topologyinventory.domain.specification.NetworkAmountSpec;
import com.joser.topologyinventory.domain.specification.NetworkAvailabilitySpec;
...
import com.joser.topologyinventory.domain.vo.Protocol;
...
public final class Switch extends Equipment {
    ...
    @Builder
    public Switch(Id id, Id routerId, Vendor vendor, Model model, IP ip, Location location,
