package com.joser.topologyinventory.framework.adapters.output.h2.mappers;
...
import com.joser.topologyinventory.framework.adapters.output.h2.data.IPData;
import com.joser.topologyinventory.framework.adapters.output.h2.data.LocationData;
import com.joser.topologyinventory.framework.adapters.output.h2.data.ModelData;
import com.joser.topologyinventory.framework.adapters.output.h2.data.NetworkData;
import com.joser.topologyinventory.framework.adapters.output.h2.data.RouterData;
import com.joser.topologyinventory.framework.adapters.output.h2.data.RouterTypeData;
import com.joser.topologyinventory.framework.adapters.output.h2.data.SwitchData;
import com.joser.topologyinventory.framework.adapters.output.h2.data.SwitchTypeData;
import com.joser.topologyinventory.framework.adapters.output.h2.data.VendorData;
