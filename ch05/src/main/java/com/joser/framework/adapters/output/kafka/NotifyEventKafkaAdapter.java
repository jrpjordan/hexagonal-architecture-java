package com.joser.framework.adapters.output.kafka;

import com.joser.application.ports.output.NotifyEventOutputPort;
import com.joser.framework.adapters.input.websocket.WebSocketClientAdapter;
...
public class NotifyEventKafkaAdapter implements NotifyEventOutputPort {
    ...
    private static String CLIENT_ID = "hexagonal_client";
    ...
    public void sendEvent(String event) {
        var record = new ProducerRecord<Long, String>(TOPIC_NAME, event);
        try {
            var metdata = producer.send(record).get();
